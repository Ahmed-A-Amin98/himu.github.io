<?php
if(isset($_FILES['img_add']) && isset($_POST['name_add']) && isset($_POST['pos_add'])  && isset($_POST['desc_add'])  )
{
$name =$_POST['name_add'];
$pos =$_POST['pos_add'];
$desc =$_POST['desc_add'];
...
if(empty($errors)){
    ...
    $sql = "insert into team (`name`,`position`,`description`, `img`) VALUES('$name','$pos','desc','$file_name')";
