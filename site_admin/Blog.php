...
<!-- start table slider -->
	<div class="container">
		...
		<?php
			...
			$sq1 = "select blog.*, team.name as team_name from blog
				...
				<table class="table ">
				  ...
				  <?php
						...
						<tr>
							...
							<td><button data-blog_id="<?php echo $value['id']; ?>" id="delete" class="btn btn-danger" data-toggle="modal" data-target="#deleteslider"><i class="fa fa-times-circle" aria-hidden="true"></i></button></td>
						</tr>
						<?php } ?>
				</table>
			</div>
