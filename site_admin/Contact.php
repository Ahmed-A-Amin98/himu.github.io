				...
				<table class="table ">
				  ...
				  <?php
						...
						<tr>
							...
							<td><button data-id="<?php echo $value['id']; ?>" data-title="<?php echo $value['name']; ?>" data-email="<?php echo $value['email']; ?>" data-msg="<?php echo $value['message']; ?>" id="edit" type="button" class="btn btn-info" data-toggle="modal" data-target="#Edit" data-whatever="@mdo" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></button></td>
